...
let stiker = await sticker(null, global.API(`https://telegra.ph/file/33b26bd723ebf4ffd60b0.jpg`), global.packname, global.author)
 conn.sendFile(m.chat, stiker, 'sticker.webp', '', m, null, { fileLength: 100, contextInfo: {
          externalAdReply :{
          showAdAttribution: true,
    mediaUrl: sgc,
    mediaType: 2,
    description: 'Dryan-MD', 
...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/adrianpreset0303r',
    mediaType: 2, 
    description: 'www.instagram.com/adrianpreset03r',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/33b26bd723ebf4ffd60b0.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/adrianpreset03'
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
           thumbnail: await (await fetch('https://telegra.ph/file/33b26bd723ebf4ffd60b0.jpg')).buffer()*/
